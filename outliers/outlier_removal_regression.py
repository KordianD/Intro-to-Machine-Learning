...
net_original = "../outliers/practice_outliers_net_worths.pkl"
net_destination = "../outliers/practice_outliers_net_worths_unix.pkl"

transform(org=original, destination=destination)
transform(org=net_original, destination=net_destination)

### load up some practice data with outliers in it
ages = pickle.load(open(destination, "rb"))
net_worths = pickle.load(open(net_destination, "rb"))
